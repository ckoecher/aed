...
public class AddPrevious extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.add_previous, menu);
		return true;
	}
	...
	private void setClickHandlers() {
		...
		btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				startActivity(new Intent(getApplicationContext() ,vco.aed.app.AddNext.class));
			}
		});
